 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function rpc($uri, $procedures = [], $delimiter = null)
        {
                        return \Illuminate\Routing\Router::rpc($uri, $procedures, $delimiter);
        }
...
')
     ...
     */ 
        ...
        public static function model($key, $class, $callback = null)
        {
                        /** @var \Sajya\Server\Binding $instance */
                        $instance->model($key, $class, $callback);
        }
                    /**
         * Add a new route parameter binder.
         ...
         * @static 
         */ 
        public static function bindResolve($procedure, $params)
        {
                        /** @var \Sajya\Server\Binding $instance */
                        return $instance->bindResolve($procedure, $params);
        }
...
namespace  { 
            ...
            class RPC extends \Sajya\Server\Facades\RPC {}
